...
process MAKEANALYSISSETS {
  ...
  cache 'deep'
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data", mode: 'copy', overwrite: true
...
process COMPUTE_PCA {
  scratch true
  label 'large'
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data/pca", mode: 'copy', overwrite: true, pattern: "*.{eigenvec,eigenval}"
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data/logs", mode: 'copy', overwrite: true, pattern: "*.log"
...
process HARMONIZE_CATEGORICAL_COVARS {
  scratch true
  label 'small'
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data", mode: 'copy', overwrite: true, pattern: "*_filtered.pca.harmonized.tsv"
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data/logs", mode: 'copy', overwrite: true, pattern: "*.cat_mapping.tsv"
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data/logs", mode: 'copy', overwrite: true, pattern: "*.cat_summary.tsv"
...
process EXPORT_PLINK {
  ...
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data", mode: 'copy', overwrite: true, pattern: "*_filtered.pca.pheno.tsv"
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data", mode: 'copy', overwrite: true, pattern: "*_covar_names.txt"
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data", mode: 'copy', overwrite: true, pattern: "*_n_covar.txt"
  publishDir "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/prepared_data/logs", mode: 'copy', overwrite: true, pattern: "*_preprocessing.log"
