...
process SAVEGWAS {
  ...
  publishDir({ "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/gwas_results/${model}/split" }, mode: 'copy', overwrite: true, pattern: "*.{results,gallop,coxph}")
  publishDir({ "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/gwas_results/${model}" }, mode: 'copy', overwrite: true, pattern: "*_allresults.tsv")
...
process MANHATTAN {
  ...
  publishDir({ "${params.project_dir}/analyses/${params.genetic_cache_key}/${params.analysis_name}/gwas_results/${model}/plots" }, mode: 'copy', overwrite: true)
